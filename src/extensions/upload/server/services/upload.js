...
module.exports = ({ strapi }) => ({
  ...
  async formatFileInfo({ filename, type, size }, fileInfo = {}, metas = {}) {
    ...
    let usedName = fileInfo.name || filename;
    usedName = usedName.toLowerCase().replace(/[^a-z0-9.]+/g, '-');
    ...
    const entity = {
      ...
      hash: usedName.replace(/[.][a-z0-9]+$/g, ''),
      ext,
      mime: type,
  ...
  async uploadFileAndPersist(fileData, { user } = {}) {
    ...
    fileData.url = 'https://private.digitalleman.com/' + fileData.name;
